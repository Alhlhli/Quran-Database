...
const TUTORIAL_STEPS = [
    ...
    { icon: 'fa-star', title: 'المفضلة والإحصائيات والمسابقة', body: 'أضف السور إلى المفضلة بالنجمة ⭐، وتفقّد صفحة الإحصائيات للرسوم البيانية، واختبر معلوماتك في صفحة «المسابقة» 🏆. استمتع! 🌙' },
];
let tutStep = 0;
